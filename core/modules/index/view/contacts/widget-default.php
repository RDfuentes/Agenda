...
<div class="btn-group pull-right">
	<a href="index.php?view=newcontact" class="btn btn-default"><i class='fa fa-male'></i> Nuevo cliente</a>
<!--<div class="btn-group pull-right">
...
<br>
		...
		if(count($users)>0){
			...
			echo "<p class='alert alert-danger'>No se encontraron clientes</p>";
		}
